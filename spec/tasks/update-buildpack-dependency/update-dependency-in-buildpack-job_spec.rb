...
require_relative '../../../tasks/update-buildpack-dependency/default_versions'
...
describe 'default_versions' do
  ...
  let(:resource_version) { '1.2.5' }
  let(:manifest_name){ 'php' }
  context 'removal strategy is not remove_all' do
    let(:removal_strategy) {'something_else'}

    it 'should not update default version' do
      defaults = DefaultVersions.new(
          manifest,
          removal_strategy,
          resource_version,
          manifest_name,
