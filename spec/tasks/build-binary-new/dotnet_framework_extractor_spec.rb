...
describe 'DotnetFrameworkExtractor' do
  ...
  it '#run(dotnet-aspnetcore) should extract and remove the Microsoft.AspNetCore.All and Microsoft.AspNetCore.App metapackages' do
    ...
    expect(FileUtils).to receive(:rmdir).with(%w(shared/Microsoft.AspNetCore.App shared/Microsoft.AspNetCore.All))
    subject.extract_aspnetcore()
  end

  it '#extract_runtime should extract and remove the Microsoft.NETCore.All' do
    ...
    expect(FileUtils).to receive(:rmdir).with(%w(shared/Microsoft.NETCore.App))
    subject.extract_runtime
  end
end
