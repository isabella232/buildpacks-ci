...
# {"org.cloudfoundry.node-engine" => ["v0.0.27", "v0.0.26", "v0.0.25"]}
# {"org.cloudfoundry.yarn" => ["new-cnb", "v0.0.26"]}
...
cnb_version_diff = ReleaseArtifacts.find_version_diffs(old_manifest_deps, current_manifest_deps)
